...
const fullNames = runners.forEach(function(names){
...
// Problem 1
const catShelter = [{'name':"Ducky", 'color': "black" , 'speak': "I like to meow"}, {'name':"minnieme", 'color': 'black', 'speak': "I like to eat."}];
const catHouse = catShelter.forEach(function(cats){
return cats.name.toUpperCase(); 
});
console.log(catHouse);
  // console.log(currentValue.state);
// Problem 2
const catColor = catShelter.filter(function(cats){
  return cats.color; 
  });
  console.log(catColor);
// Problem 3
const catTalk= catShelter.map(function(cats){
  return cats.speak; 
  });
  console.log(catTalk);